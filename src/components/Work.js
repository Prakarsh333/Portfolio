...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  ...
  <h2 class="text-2xl md:text-4xl md:leading-tight dark:text-black">Working <span class="font-bold">Experience</span></h2>
  ...
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div id="Experience" class="sticky top-0 h-screen flex flex-col items-center justify-center bg-gradient-to-b from-indigo-800 to-purple-800">
    <h2 class="text-2xl md:text-4xl md:leading-tight font-mono dark:text-white">Featured <span class="font-bold">Projects</span></h2>
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
  <div class="grid sm:grid-cols-2 lg:grid-cols-3 items-center gap-6 md:gap-10">
	...
	<div className="container mx-auto flex flex-col p-6">
		<h2 className="py-4 text-3xl font-bold text-center">Work Experience</h2>
		<div className="divide-y dark:divide-gray-300">
			<div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
				<div className="flex items-center justify-center lg:col-span-1 col-span-full">
          <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQUQpc9i74M2yHZFFY9sUX6phUvEcTNSpnqwg&s" class="h-24, w-24"></img>
				</div>
				<div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
					<span className="text-xs tracking-wider uppercase dark:text-violet-600">January 2024 - March 2024</span>
					<span className="text-xl font-bold md:text-2xl">SDE Intern at One Immersive</span>
			...
			<div className="grid justify-center grid-cols-4 p-8 mx-auto space-y-8 lg:space-y-0">
				<div className="flex items-center justify-center lg:col-span-1 col-span-full">
          <img src="https://yt3.googleusercontent.com/t-LQtSEGx32XWawrXg27be00C0ILo2m4N495zkFECn5B81HXiClq9HDnkZ_Vgh4E1BzXFXrv=s900-c-k-c0x00ffffff-no-rj" class="h-24, w-24"></img>
				</div>
				<div className="flex flex-col justify-center max-w-3xl text-center col-span-full lg:col-span-3 lg:text-left">
					<span className="text-xs tracking-wider uppercase dark:text-violet-600">June 2024 - July 2024</span>
					<span className="text-xl font-bold md:text-2xl">SDE Intern at CyfrOne</span>
					<span className="mt-4 dark:text-gray-700">Lorem ipsum dolor sit amet consectetur adipisicing elit. Aperiam facilis, voluptates error alias dolorem praesentium sit soluta iure incidunt labore explicabo eaque, quia architecto veritatis dolores, enim cons equatur nihil ipsum.</span>
				</div>
			</div>
